...
let
  ...
  src = fetchFromGitHub {
    ...
    owner = "rdo";
    repo = "mia";
    rev = "6e6193ceb325a0077f7a49051276cbdd6be60736";
    # tag = "v${version}-mia";
    hash = "sha256-qrYbdhII6jOPdztk7JxNlOz8vxef7G8WmMGOQr2vb5A=";
    curlOptsList = [
      "--location"
      "--cacert"
      "${customCaBundle}"
  ...
  node_modules = stdenvNoCC.mkDerivation {
    ...
    outputHash = "sha256-pOGHE02eoZzSkQwfUmG2EVaN80mBxKhIW+BFEufTh3w=";
...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    mkdir -p $out/bin
    makeWrapper ${lib.getExe bun} $out/bin/mia \
      --add-flags "run" \
